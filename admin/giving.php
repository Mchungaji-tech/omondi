...
<div class="phead">
  <div>
    ...
    <p>Controls the official M-Pesa Paybill, bank transfer, and SWIFT instructions on the public site</p>
  </div>
</div>
  ...
  <form method="post">
    ...
    <div class="mrow2">
      ...
      <div class="field">
        ...
        <input type="text" name="swift_code" value="<?= esc($s['swift_code'] ?? '') ?>">
      </div>
    </div>
